package com.meritamerica.assignment6.accounts;
...
public class BankAccount {
	...
	public boolean withdraw(double amount) throws ExceedsAvailableBalanceException, NoResourceFoundException {
		if (amount > this.balance) {
			throw new ExceedsAvailableBalanceException("Withdraw Amount Exceeds Available Balance");
		}
		if (amount < 0) {
			throw new NoResourceFoundException("Unable To Withdraw A Negative Value");
		}
